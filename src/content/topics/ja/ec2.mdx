...
<SequenceDiagram
  ...
  steps={[
    ...
    { from: 'ec2', to: 'client', label: '200 OK — 本文 1GB', reply: true, meter: 'egress', charge: '1 GB × $0.09' },
  ]}
/>
...
<PathDiagram
  ...
  hops={[
    { from: 'ec2', to: 'nat', label: 'NAT の処理', meter: 'egress', cost: '約 $0.045/GB' },
    { from: 'nat', to: 'net', label: 'データ転送 OUT', meter: 'egress', cost: '$0.09/GB' },
  ]}
/>
